...
DESCRIPTION:
	...
	TweenMax uses the same easy-to-learn syntax as its siblincom.blenderbox.motion. In fact, since it extends them, TweenMax can do anything TweenLite 
...
EXAMPLES: 
	...
	you'd do so like:
		...
		import com.blenderbox.motion.TweenMax;
	...
	that gets called when the tween completes, you could do:
		...
		import com.blenderbox.motion.TweenMax;
		import com.blenderbox.motion.events.TweenEvent;
